...
/*   Updated: 2022/05/15 16:42:03 by kyujlee          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*philo_eating(t_philo *philo)
{
    ...
    philo_pause(philo->info,curr_time(philo->info), philo->info->rules.time_to_eat);
...
void	*philo_sleeping(t_philo *philo)
{
	...
	philo_pause(philo->info, curr_time(philo->info), philo->info->rules.time_to_sleep);
